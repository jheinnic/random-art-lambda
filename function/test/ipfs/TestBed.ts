...
const vals2: Uint8Array = Uint8Array.from( [ 11, 21, 31, 41, 51, 61, 71, 81, 91, 101 ] )
const key1: CID = CID.parse( "QmNpkD74ocpUBFztzcAf9KRGXCE7be6C3SDjtSy3dBFDzR" )
const key2: CID = CID.parse( "QmeXewWTbGUnvAPQ5VUcJ2uF3PX1uWbZg1Yjk9EJzQqzXF" )

@Injectable()
export class TestBed {
  constructor (
    @Inject( MY_BLOCK_STORE )
    private blockStore: BaseBlockstore
  ) { }
