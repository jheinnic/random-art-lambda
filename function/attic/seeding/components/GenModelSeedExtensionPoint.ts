...
import {
   ...
   PAINTABLE_PHRASE_PAIR_STRING,
   PAINTABLE_PREFIX_SUFFIX_STRING,
   PAINTABLE_SINGLE_PHRASE_STRING,
...
export class GenModelSeedExtensionPoint implements IGMSeedExtensionPoint {
   ...
   receiveExtensions(
      ...
      adapters: {
         [GEN_MODEL_SEED_ADAPTER_ID_STRING]: IAdapterCollection<
            GEN_MODEL_SEED_EXTENSION_POINT,
            GEN_MODEL_SEED_ADAPTER_ID
         >
      },
      ...
      this.adapters = adapters[GEN_MODEL_SEED_ADAPTER_ID_STRING]
   }
   ...
   toSeedModel(
      ...
      return adapter.toPaintable(input)
   }
}
