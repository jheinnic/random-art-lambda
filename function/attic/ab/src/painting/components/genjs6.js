...
(
        ...
        loop: while (true) {
          ...
          switch (cmd) {
            ...
            case -5:
              if (caml_parser_trace) {
                print(
                  "State " + state + ": shift to state " + Short(tables[11], n2)
                )
              }
  ...
  @end @ */
      const oc$Pervasives$ = (function () {
        ...
        const unsafe_really_input$266 = _f(function (
          ic$267,
          s$268,
          ofs$269,
          len$270
      ...
      const oc$List$ = (function () {
        ...
        const for_all$165 = _f(function (p$166, param$377) {
          if (param$377) {
            return (
              _(p$166, [param$377[0]]) && _(for_all$165, [p$166, param$377[1]])
            )
          }
          return true
        })
        const exists$169 = _f(function (p$170, param$376) {
          if (param$376) {
            return (
              _(p$170, [param$376[0]]) || _(exists$169, [p$170, param$376[1]])
            )
          }
          return false
        })
        ...
        const mem_assq$212 = _f(function (x$213, param$362) {
          if (param$362) {
            return (
              param$362[0][0] === x$213 || _(mem_assq$212, [x$213, param$362[1]])
            )
          }
          return false
        })
      ...
      const oc$Myrandom$ = (function () {
        const State$139 = (function () {
          ...
          const rawfloat$128 = _f(function (s$129) {
            ...
            return (
              ((r0$131 / scale$130 + r1$132) / scale$130 + r2$133) / scale$130
            )
          })
      ...
      const oc$Util$ = (function () {
        ...
        const range$80 = _f(function (
          ...
          return (
            ...
            (max$91 - min$88) *
            Math.abs(
              _(mod_float$27$75, [Math.abs(x$93 - a$82), 2.0 * (b$85 - a$82)]) /
              (b$85 - a$82) -
              1.0
            )
          )
        ...
        const rgb_range$94 = _f(function ($2Aopt$2A$95, $2Aopt$2A$98, x$101) {
          ...
          return (
            min$96 + (max$99 - min$96) * (0.5 + Math.atan(2.0 * x$101) / pi$74)
          )
        })
                          ...
                          switch ($t(match$879)) {
                            case 2:
                              ...
                              const r$186 = Math.sqrt(
                                u$27$183 * u$27$183 + v$27$184 * v$27$184
                              )
                              return $2(
                        ...
                        case 2:
                          ...
                          switch ($t(match$857)) {
                            case 2:
                              ...
                              return $1(
                                Math.sqrt(
                                  2.0 * (dx$227 * dx$227 + dy$228 * dy$228)
                                ) - 1.0
                              )
                            default:
                            ...
                            switch ($t(match$788)) {
                              case 1:
                                const t$307 = Math.abs(
                                  _(oc$Util$[2], [0, 0, 0, 0, match$788[0]])
                                )
                                return $2(
                                  t$307 * match$790[0] +
                    ...
                    switch ($t(match$750)) {
                      case 1:
                        ...
                        switch ($t(match$749)) {
                          case 1:
                            return $1(
                              _(oc$Pervasives$[4], [match$750[0], match$749[0]])
                            )
                          default:
                              ...
                              try {
                                const match$681 = _(oc$List$[25], [
                                  _f(function (param$679) {
                                    ...
                                    return (
                                      a$397 * a$397 + b$398 * b$398 < param$679[1]
                                    )
                                  }),
                                  fs$380
                                ])
      ...
      const oc$Gene$ = (function () {
            ...
            if (j$133 <= 1) {
              {
                ...
                if (fs$139) {
                  return $(
                    _(connect$123, [_(oc$Util$[14], [fs$139]), lst1$135]),
                    lst$134
                  )
                }
                if (j$133 < -k$131 - 5) {
        ...
        const random_dna$156 = _f(function (
          ops$157,
          seed$158,
          res$159,
          k$160,
      ...
      const oc$Compute$ = (function () {
        ...
        const compute_line$119 = _f(function (
          rna$120,
          res$121,
          t$122,
          j$123,
