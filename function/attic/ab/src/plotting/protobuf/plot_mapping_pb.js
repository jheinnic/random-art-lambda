...
proto.plot_mapping.v1.PointPlotData.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(2, f, proto.plot_mapping.v1.ImageSize.serializeBinaryToWriter);
    }
    f = message.getMappedRegion();
    if (f != null) {
        writer.writeMessage(3, f, proto.plot_mapping.v1.RegionBoundary.serializeBinaryToWriter);
    }
...
proto.plot_mapping.v1.PointPlotData.prototype.getResolution = function () {
    return /** @type{?proto.plot_mapping.v1.ImageSize} */ (jspb.Message.getWrapperField(this, proto.plot_mapping.v1.ImageSize, 2));
};
/**
...
proto.plot_mapping.v1.PointPlotData.prototype.getMappedRegion = function () {
    return /** @type{?proto.plot_mapping.v1.RegionBoundary} */ (jspb.Message.getWrapperField(this, proto.plot_mapping.v1.RegionBoundary, 3));
};
/**
...
proto.plot_mapping.v1.PointPlotMeta.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getOrigin();
    if (f != null) {
        writer.writeMessage(4, f, proto.plot_mapping.v1.BuildId.serializeBinaryToWriter);
    }
};
/**
...
proto.plot_mapping.v1.PointPlotMeta.prototype.getOrigin = function () {
    return /** @type{?proto.plot_mapping.v1.BuildId} */ (jspb.Message.getWrapperField(this, proto.plot_mapping.v1.BuildId, 4));
};
/**
...
proto.plot_mapping.v1.PointPlotDocument.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getMeta();
    if (f != null) {
        writer.writeMessage(1, f, proto.plot_mapping.v1.PointPlotMeta.serializeBinaryToWriter);
    }
    f = message.getData();
    if (f != null) {
        writer.writeMessage(2, f, proto.plot_mapping.v1.PointPlotData.serializeBinaryToWriter);
    }
};
/**
...
proto.plot_mapping.v1.PointPlotDocument.prototype.getMeta = function () {
    return /** @type{?proto.plot_mapping.v1.PointPlotMeta} */ (jspb.Message.getWrapperField(this, proto.plot_mapping.v1.PointPlotMeta, 1));
};
/**
...
proto.plot_mapping.v1.PointPlotDocument.prototype.getData = function () {
    return /** @type{?proto.plot_mapping.v1.PointPlotData} */ (jspb.Message.getWrapperField(this, proto.plot_mapping.v1.PointPlotData, 2));
};
/**
...
//# sourceMappingURL=plot_mapping_pb.js.map