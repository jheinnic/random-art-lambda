...
export const SHARED_ART_BLOCKSTORE: unique symbol = Symbol(
   "SharedArtBlockstore",
)
...
export const IPLD_ARTWORK_ITEM_SERDES: unique symbol =
   Symbol("ArtworkItemSerdes")
export const IPLD_PAINT_TASK_SERDES: unique symbol = Symbol("PaintTaskSerdes")
export const IPLD_PLOT_REGION_TASK_SERDES: unique symbol = Symbol(
   "PlotRegionTaskSerdes",
)
