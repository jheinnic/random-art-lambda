...
const methodHolder = {
   newNewPicture: undefined,
   newPicture: undefined,
   oldPicture: undefined,
   computePixel: undefined,
   phraseToSeed: undefined,
   partialEval: undefined,
   fullEval: undefined,
   substringChars: undefined,
}

;(function (methodHolder) {
   function ocamlRegister(name, fn) {
   ...
   const ocamljs$caml_named_value = (function () {
         ...
         if (t1 == t2) {
            switch (t1) {
               ...
               case "object":
                  ...
                  if (v1._m != null && v2._m != null) {
                     // i.e. an OCaml object XXX better test
                     const oid1 = v1[1]
                     const oid2 = v2[1]
                     if (oid1 < oid2) {
                        return LESS
      ...
      const caml_sys_time = function () {
         return new Date().getTime() / 1000 - init_time
      }
      ...
      function Short(tbl, n) {
         const s = tbl.charCodeAt(n * 2) + (tbl.charCodeAt(n * 2 + 1) << 8)
  ...
  @end @ */
      ...
      function oc$$asets(o, i, v) {
         return i < o.length
            ? (o[i] = v)
            : oc$Pervasives$[0]("index out of bounds")
      }
      ...
      if (typeof Number.prototype.toFixed !== "undefined") {
         ;(function () {
            ...
            function StrU(X, M, N) {
               ...
               return RR.substring(0, (T = length - N)) + "." + substring(T)
            }
      ...
      const oc$$sprintf = function () {
         ...
         let argumentnum = 0
         let done = ""
         let todo = arguments[argumentnum++]

         /*  parse still to be done format string  */
         let m
         while (
            (m =
               /^([^%]*)%(\d+$)?([\-#0\ +\']+)?(\*|\d+)?(\.\*|\.\d+)?([%dioulLnNxXfFgGcs])(.*)$/.exec(
                  todo,
               ))
         ) {
            const pProlog = m[1]
            const pAccess = m[2]
            let pFlags = m[3]
            const pMinLength = m[4]
            const pPrecision = m[5]
            const pType = m[6]
            const pEpilog = m[7]
            ...
            if (pType == "%") {
               ...
               if (pAccess) {
                  access = parseInt(
                     pAccess.substring(0, pAccess.length - 1),
                     10,
                  )
               }
               if (access >= arguments.length) {
                  ...
                  case "G":
                     ...
                     if (precision > -1) {
                        if (subst.toFixed) {
                           ...
                           subst =
                              Math.round(subst * Math.pow(10, precision)) /
                              Math.pow(10, precision)
                           subst += "0000000000"
                           subst = subst.substr(
                              0,
                              subst.indexOf(".") + precision + 1,
                           )
                        }
                     }
                     subst = "" + subst
               ...
               const padding =
                  minLength - subst.toString().length - prefix.toString().length
               if (padding > 0) {
  ...
  @end @ */
      const oc$Pervasives$ = (function () {
         ...
         const epsilon_float$136 = caml_int64_float_of_bits(
            "4372995238176751616",
         )
         const $5E$152 = _f(function (s1$153, s2$154) {
            return s1$153.toString() + s2$154.toString()
         })
         const char_of_int$157 = _f(function (n$158) {
         ...
         const bool_of_string$166 = _f(function (param$428) {
         ...
         const String$171 = $()
         const valid_float_lexem$172 = _f(function (s$173) {
            const l$174 = s$173.length
            const loop$175 = _f(function (i$176) {
               if (i$176 >= l$174) {
         ...
         const $40$180 = _f(function (l1$181, l2$182) {
            if (l1$181) {
         ...
         const open_out_gen$212 = _f(function (mode$213, perm$214, name$215) {
            return caml_ml_open_descriptor_out(
               caml_sys_open(name$215, mode$213, perm$214),
            )
         })
         const open_out$216 = _f(function (name$217) {
            return __(open_out_gen$212, [
               $(1, $(3, $(4, $(7, 0)))),
               438,
               name$217,
            ])
         ...
         const flush_all$222 = _f(function (param$424) {
            const iter$223 = _f(function (param$425) {
               if (param$425) {
                  {
                     try {
         ...
         const output$231 = _f(function (oc$232, s$233, ofs$234, len$235) {
            if (
               ofs$234 < 0 ||
               len$235 < 0 ||
               ofs$234 > s$233.length - len$235
            ) {
         ...
         const close_out_noerr$248 = _f(function (oc$249) {
            try {
         ...
         const open_in_gen$251 = _f(function (mode$252, perm$253, name$254) {
            return caml_ml_open_descriptor_in(
               caml_sys_open(name$254, mode$252, perm$253),
            )
         })
         ...
         const input$261 = _f(function (ic$262, s$263, ofs$264, len$265) {
            if (
               ofs$264 < 0 ||
               len$265 < 0 ||
               ofs$264 > s$263.length - len$265
            ) {
               return __(invalid_arg$56, ["input"])
            }
            return caml_ml_input(ic$262, s$263, ofs$264, len$265)
         })
         const unsafe_really_input$266 = _f(
            function (ic$267, s$268, ofs$269, len$270) {
               if (len$270 <= 0) {
                  return 0
               }
               ...
               return __(unsafe_really_input$266, [
                  ic$267,
                  s$268,
                  ofs$269 + r$271,
                  len$270 - r$271,
         ...
         const really_input$272 = _f(
            function (ic$273, s$274, ofs$275, len$276) {
               if (
                  ofs$275 < 0 ||
                  len$276 < 0 ||
                  ofs$275 > s$274.length - len$276
               ) {
         ...
         const input_line$278 = _f(function (chan$279) {
            const build_result$280 = _f(function (buf$281, pos$282, param$421) {
               if (param$421) {
                  {
            ...
            const scan$286 = _f(function (accu$287, len$288) {
         ...
         const print_int$307 = _f(function (i$308) {
            return __(output_string$228, [
               stdout$190,
               _(string_of_int$167, [i$308]),
            ])
         })
         const print_float$309 = _f(function (f$310) {
            return __(output_string$228, [
               stdout$190,
               _(string_of_float$177, [f$310]),
            ])
         })
         const print_endline$311 = _f(function (s$312) {
         ...
         const prerr_int$318 = _f(function (i$319) {
            return __(output_string$228, [
               stderr$191,
               _(string_of_int$167, [i$319]),
            ])
         })
         const prerr_float$320 = _f(function (f$321) {
            return __(output_string$228, [
               stderr$191,
               _(string_of_float$177, [f$321]),
            ])
         })
         const prerr_endline$322 = _f(function (s$323) {
         ...
         const string_of_format$352 = _f(function (fmt$353) {
            const s$354 = fmt$353
         ...
         const at_exit$359 = _f(function (f$360) {
         ...
         return $(
            ...
            open_in_bin$257,
            open_in_gen$251,
            _f(function (prim$394) {
               return caml_ml_input_char(prim$394)
            }),
            input_line$278,
            input$261,
            really_input$272,
            _f(function (prim$395) {
            ...
            string_of_format$352,
            $5E$5E$349,
            exit$363,
            at_exit$359,
            valid_float_lexem$172,
            unsafe_really_input$266,
            do_at_exit$362,
         )
      })()
      const oc$Char$ = (function () {
         ...
         const escaped$66 = _f(function (c$67) {
            let $r7 = false
            r$7: {
               {
                  if (!(c$67 !== 39)) {
         ...
         const lowercase$71 = _f(function (c$72) {
            if (
               (c$72 >= 65 && c$72 <= 90) ||
               (c$72 >= 192 && c$72 <= 214) ||
               (c$72 >= 216 && c$72 <= 222)
         ...
         const uppercase$73 = _f(function (c$74) {
            if (
               (c$74 >= 97 && c$74 <= 122) ||
               (c$74 >= 224 && c$74 <= 246) ||
               (c$74 >= 248 && c$74 <= 254)
      ...
      const oc$List$ = (function () {
         const length_aux$58 = _f(function (len$59, param$394) {
            if (param$394) {
         ...
         const nth$70 = _f(function (l$71, n$72) {
            if (n$72 < 0) {
               return __(oc$Pervasives$[0], ["List.nth"])
            }
            const nth_aux$73 = _f(function (l$74, n$75) {
               if (!l$74) {
         ...
         const rev_append$79 = _f(function (l1$80, l2$81) {
            if (l1$80) {
         ...
         const flatten$86 = _f(function (param$391) {
            if (param$391) {
               return __(oc$Pervasives$[21], [
                  param$391[0],
                  _(flatten$86, [param$391[1]]),
               ])
            }
            return 0
         })
         const map$90 = _f(function (f$91, param$390) {
            if (param$390) {
               {
         ...
         const rev_map$95 = _f(function (f$96, l$97) {
            const rmap_f$98 = _f(function (accu$99, param$389) {
               if (param$389) {
                  return __(rmap_f$98, [
                     $(_(f$96, [param$389[0]]), accu$99),
                     param$389[1],
                  ])
               }
               return accu$99
         ...
         const iter$102 = _f(function (f$103, param$388) {
            if (param$388) {
               {
                  _(f$103, [param$388[0]])
         ...
         const fold_left$106 = _f(function (f$107, accu$108, l$109) {
            if (l$109) {
               return __(fold_left$106, [
                  f$107,
                  _(f$107, [accu$108, l$109[0]]),
                  l$109[1],
               ])
            }
            return accu$108
         })
         const fold_right$112 = _f(function (f$113, l$114, accu$115) {
            if (l$114) {
               return __(f$113, [
                  l$114[0],
                  _(fold_right$112, [f$113, l$114[1], accu$115]),
               ])
            }
            return accu$115
         })
         const map2$118 = _f(function (f$119, l1$120, l2$121) {
            let $r34 = false
            r$34: {
               {
                  if (!l1$120) {
         ...
         const rev_map2$127 = _f(function (f$128, l1$129, l2$130) {
            const rmap2_f$131 = _f(function (accu$132, l1$133, l2$134) {
               let $r31 = false
               r$31: {
                  {
                     if (!l1$133) {
                     ...
                     return __(rmap2_f$131, [
                        $(_(f$128, [l1$133[0], l2$134[0]]), accu$132),
                        l1$133[1],
                        l2$134[1],
                     ])
                  }
         ...
         const iter2$139 = _f(function (f$140, l1$141, l2$142) {
            let $r30 = false
            r$30: {
               {
                  if (!l1$141) {
         ...
         const fold_left2$147 = _f(function (f$148, accu$149, l1$150, l2$151) {
            let $r29 = false
            r$29: {
               {
                  if (!l1$150) {
                  ...
                  return __(fold_left2$147, [
                     f$148,
                     _(f$148, [accu$149, l1$150[0], l2$151[0]]),
                     l1$150[1],
                     l2$151[1],
                  ])
               }
         ...
         const fold_right2$156 = _f(function (f$157, l1$158, l2$159, accu$160) {
            let $r28 = false
            r$28: {
               {
                  if (!l1$158) {
         ...
         const for_all$165 = _f(function (p$166, param$377) {
            if (param$377) {
               return (
                  _(p$166, [param$377[0]]) &&
                  _(for_all$165, [p$166, param$377[1]])
               )
            }
            return true
         })
         const exists$169 = _f(function (p$170, param$376) {
            if (param$376) {
               return (
                  _(p$170, [param$376[0]]) ||
                  _(exists$169, [p$170, param$376[1]])
               )
            }
            return false
         })
         const for_all2$173 = _f(function (p$174, l1$175, l2$176) {
            let $r27 = false
            r$27: {
               {
                  if (!l1$175) {
                  ...
                  return (
                     _(p$174, [l1$175[0], l2$176[0]]) &&
                     _(for_all2$173, [p$174, l1$175[1], l2$176[1]])
                  )
               }
            }
            if ($r27) {
         ...
         const exists2$181 = _f(function (p$182, l1$183, l2$184) {
            let $r26 = false
            r$26: {
               {
                  if (!l1$183) {
                  ...
                  return (
                     _(p$182, [l1$183[0], l2$184[0]]) ||
                     _(exists2$181, [p$182, l1$183[1], l2$184[1]])
                  )
               }
            }
            if ($r26) {
         ...
         const mem$189 = _f(function (x$190, param$371) {
            if (param$371) {
               return (
                  caml_compare(param$371[0], x$190) === 0 ||
                  _(mem$189, [x$190, param$371[1]])
               )
            }
            return false
         })
         const memq$193 = _f(function (x$194, param$370) {
            if (param$370) {
               return (
                  param$370[0] === x$194 || _(memq$193, [x$194, param$370[1]])
               )
            }
            return false
         })
         const assoc$197 = _f(function (x$198, param$368) {
            if (param$368) {
               {
         ...
         const assq$202 = _f(function (x$203, param$366) {
            if (param$366) {
               {
         ...
         const mem_assoc$207 = _f(function (x$208, param$364) {
            if (param$364) {
               return (
                  caml_compare(param$364[0][0], x$208) === 0 ||
                  _(mem_assoc$207, [x$208, param$364[1]])
               )
            }
            return false
         })
         const mem_assq$212 = _f(function (x$213, param$362) {
            if (param$362) {
               return (
                  param$362[0][0] === x$213 ||
                  _(mem_assq$212, [x$213, param$362[1]])
               )
            }
            return false
         })
         const remove_assoc$217 = _f(function (x$218, param$361) {
            if (param$361) {
               {
         ...
         const remove_assq$223 = _f(function (x$224, param$360) {
            if (param$360) {
               {
         ...
         const find$229 = _f(function (p$230, param$359) {
            if (param$359) {
               {
         ...
         const find_all$233 = _f(function (p$234) {
            const find$235 = _f(function (accu$236, param$358) {
               if (param$358) {
                  {
         ...
         const partition$240 = _f(function (p$241, l$242) {
            const part$243 = _f(function (yes$244, no$245, param$357) {
               if (param$357) {
                  {
         ...
         const split$248 = _f(function (param$354) {
            if (param$354) {
               {
                  const match$356 = param$354[0]
                  const match$355 = _(split$248, [param$354[1]])
                  return $(
                     $(match$356[0], match$355[0]),
                     $(match$356[1], match$355[1]),
                  )
               }
            }
            return $(0, 0)
         })
         const combine$254 = _f(function (l1$255, l2$256) {
            let $r21 = false
            r$21: {
               {
                  if (!l1$255) {
                  ...
                  return $(
                     $(l1$255[0], l2$256[0]),
                     _(combine$254, [l1$255[1], l2$256[1]]),
                  )
               }
            }
            if ($r21) {
         ...
         const merge$261 = _f(function (cmp$262, l1$263, l2$264) {
            if (!l1$263) {
               return l2$264
            }
            if (l2$264) {
               {
                  ...
                  if (_(cmp$262, [h1$267, h2$269]) <= 0) {
                     return $(
                        h1$267,
                        _(merge$261, [cmp$262, l1$263[1], l2$264]),
                     )
                  }
         ...
         const chop$271 = _f(function (k$272, l$273) {
            if (k$272 === 0) {
               return l$273
            }
            if (l$273) {
         ...
         const stable_sort$276 = _f(function (cmp$277, l$278) {
            const rev_merge$279 = _f(function (l1$280, l2$281, accu$282) {
               if (!l1$280) {
            ...
            const rev_merge_rev$289 = _f(function (l1$290, l2$291, accu$292) {
               if (!l1$290) {
            ...
            const sort$299 = _f(function (n$301, l$302) {
               let $r9 = false
               r$9: {
                  {
                     if (!(n$301 !== 2)) {
                     ...
                     if (!(_(cmp$277, [x1$305, x2$306]) <= 0)) {
                        {
                           if (_(cmp$277, [x1$305, x3$307]) <= 0) {
                              return $(x2$306, $(x1$305, $(x3$307, 0)))
                           }
                           if (_(cmp$277, [x2$306, x3$307]) <= 0) {
                              return $(x2$306, $(x3$307, $(x1$305, 0)))
                           }
            ...
            const rev_sort$300 = _f(function (n$315, l$316) {
               let $r15 = false
               r$15: {
                  {
                     if (!(n$315 !== 2)) {
      ...
      const oc$String$ = (function () {
         ...
         const fill$79 = _f(function (s$80, ofs$81, len$82, c$83) {
            if (ofs$81 < 0 || len$82 < 0 || ofs$81 > s$80.length - len$82) {
               return __(oc$Pervasives$[0], ["String.fill"])
            }
            return caml_fill_string(s$80, ofs$81, len$82, c$83)
         })
         const blit$84 = _f(function (s1$85, ofs1$86, s2$87, ofs2$88, len$89) {
            if (
               len$89 < 0 ||
               ofs1$86 < 0 ||
               ofs1$86 > s1$85.length - len$89 ||
               ofs2$88 < 0 ||
               ofs2$88 > s2$87.length - len$89
            ) {
               return __(oc$Pervasives$[0], ["String.blit"])
            }
            return caml_blit_string(s1$85, ofs1$86, s2$87, ofs2$88, len$89)
         })
         const iter$90 = _f(function (f$91, a$92) {
         ...
         const concat$94 = _f(function (sep$95, l$96) {
            if (l$96) {
               {
                  const hd$97 = l$96[0]
                  const num$99 = $(0)
                  ...
                  const r$102 = oc$$cms(
                     len$100[0] + sep$95.length * (num$99[0] - 1),
                  )
         ...
         const escaped$108 = _f(function (s$109) {
            let n$110 = 0
         ...
         const map$118 = _f(function (f$119, s$120) {
         ...
         const apply1$128 = _f(function (f$129, s$130) {
            if (s$130.length === 0) {
               return s$130
            }
         ...
         const index_rec$136 = _f(function (s$137, lim$138, i$139, c$140) {
            if (i$139 >= lim$138) {
               throw $(Not_found$20g)
            }
         ...
         const index_from$144 = _f(function (s$145, i$146, c$147) {
         ...
         const rindex_rec$149 = _f(function (s$150, i$151, c$152) {
            if (i$151 < 0) {
               throw $(Not_found$20g)
            }
         ...
         const rindex_from$156 = _f(function (s$157, i$158, c$159) {
            if (i$158 < -1 || i$158 >= s$157.length) {
               return __(oc$Pervasives$[0], ["String.rindex_from"])
            }
            return __(rindex_rec$149, [s$157, i$158, c$159])
         })
         const contains_from$160 = _f(function (s$161, i$162, c$163) {
         ...
         const rcontains_from$168 = _f(function (s$169, i$170, c$171) {
            if (i$170 < 0 || i$170 >= s$169.length) {
               return __(oc$Pervasives$[0], ["String.rcontains_from"])
            }
            try {
      ...
      const oc$Array$ = (function () {
         const init$65 = _f(function (l$66, f$67) {
            if (l$66 === 0) {
               return $()
            }
         ...
         const make_matrix$70 = _f(function (sx$71, sy$72, init$73) {
         ...
         const copy$77 = _f(function (a$78) {
         ...
         const append$82 = _f(function (a1$83, a2$84) {
         ...
         const concat_aux$90 = _f(function (init$91, al$92) {
            const size$93 = _f(function (accu$94, param$262) {
               if (param$262) {
                  return __(size$93, [
                     accu$94 + param$262[0].length,
                     param$262[1],
                  ])
               }
               return accu$94
            ...
            const fill$98 = _f(function (pos$99, param$261) {
               if (param$261) {
                  {
         ...
         const concat$103 = _f(function (al$104) {
            const find_init$105 = _f(function (param$260) {
               if (param$260) {
                  {
         ...
         const sub$108 = _f(function (a$109, ofs$110, len$111) {
            if (
               ofs$110 < 0 ||
               len$111 < 0 ||
               ofs$110 > a$109.length - len$111
            ) {
         ...
         const fill$114 = _f(function (a$115, ofs$116, len$117, v$118) {
            if (
               ofs$116 < 0 ||
               len$117 < 0 ||
               ofs$116 > a$115.length - len$117
            ) {
         ...
         const blit$120 = _f(
            function (a1$121, ofs1$122, a2$123, ofs2$124, len$125) {
               if (
                  len$125 < 0 ||
                  ofs1$122 < 0 ||
                  ofs1$122 > a1$121.length - len$125 ||
                  ofs2$124 < 0 ||
                  ofs2$124 > a2$123.length - len$125
               ) {
         ...
         const iter$128 = _f(function (f$129, a$130) {
         ...
         const map$132 = _f(function (f$133, a$134) {
         ...
         const iteri$138 = _f(function (f$139, a$140) {
         ...
         const mapi$142 = _f(function (f$143, a$144) {
         ...
         const to_list$148 = _f(function (a$149) {
            const tolist$150 = _f(function (i$151, res$152) {
               if (i$151 < 0) {
                  return res$152
               }
         ...
         const list_length$153 = _f(function (accu$154, param$259) {
            if (param$259) {
               return __(list_length$153, [1 + accu$154, param$259[1]])
            }
            return accu$154
         })
         const of_list$157 = _f(function (l$160) {
            if (l$160) {
               {
                  const a$161 = caml_make_vect(
                     _(list_length$153, [0, l$160]),
                     l$160[0],
                  )
                  const fill$162 = _f(function (i$163, param$258) {
                     if (param$258) {
                        {
         ...
         const fold_left$166 = _f(function (f$167, x$168, a$169) {
            let r$170 = x$168
         ...
         const fold_right$172 = _f(function (f$173, a$174, x$175) {
            let r$176 = x$175
         ...
         const sort$179 = _f(function (cmp$180, a$181) {
            const maxson$182 = _f(function (l$183, i$184) {
            ...
            const trickle$192 = _f(function (l$193, i$194, e$195) {
               try {
            ...
            const trickleup$205 = _f(function (i$206, e$207) {
               const father$208 = ((i$206 - 1) / 3) >> 0
               if (i$206 !== father$208) {
               } else {
                  throw $(
                     Assert_failure$26g,
                     $("ocaml/stdlib/array.ml", 208, 4),
                  )
               }
         ...
         const cutoff$214 = 5
         const stable_sort$215 = _f(function (cmp$216, a$217) {
            const merge$218 = _f(
               function (
                  src1ofs$219,
                  src1len$220,
                  ...
                  const loop$228 = _f(
                     function (i1$229, s1$230, i2$231, s2$232, d$233) {
            ...
            const isortto$236 = _f(
               function (srcofs$237, dst$238, dstofs$239, len$240) {
                  for (let i$241 = 0; i$241 <= len$240 - 1; i$241++) {
                     ;(function (i$241) {
                        ...
                        while (
                           j$243 >= dstofs$239 &&
                           _(cmp$216, [oc$$arefs(dst$238, j$243), e$242]) > 0
                        ) {
                           {
                              oc$$asets(
                                 dst$238,
                                 j$243 + 1,
                                 oc$$arefs(dst$238, j$243),
                              )
                              j$243 = -1 + j$243
                           }
                        }
            ...
            const sortto$244 = _f(
               function (srcofs$245, dst$246, dstofs$247, len$248) {
                  if (len$248 <= cutoff$214) {
                     return __(isortto$236, [
                        srcofs$245,
                        dst$246,
                        dstofs$247,
                        len$248,
      ...
      const oc$Sys$ = (function () {
         ...
         const max_string_length$65 =
            ((word_size$63 / 8) >> 0) * max_array_length$64 - 1
         ...
         const catch_break$110 = _f(function (on$111) {
            if (on$111) {
               return __(set_signal$85, [
                  sigint$93,
                  $(
                     _f(function (param$116) {
                        throw $(Break$109)
                     }),
                  ),
               ])
      ...
      const oc$Ocamljs$ = (function () {
         ...
         return $(
            option_of_nullable$74,
            nullable_of_option$76,
            is_null$79,
            Inline$268,
         )
      })()
      const oc$Types$ = (function () {
         const value$96 = _f(function (param$132) {
            return param$132[0][0]
         })
         const sorts$98 = $(0, $(1, $(2, $(3, 0))))
         const string_of_color$99 = _f(function (param$131) {
         ...
         const string_of_sort$103 = _f(function (param$130) {
            switch (param$130) {
               case 0:
                  return "bool"
               case 1:
      ...
      const oc$Myrandom$ = (function () {
         const State$139 = (function () {
            const new_state$63 = _f(function (param$197) {
               return $(caml_make_vect(55, 0), 0)
            })
            const assign$64 = _f(function (st1$65, st2$66) {
               _(oc$Array$[8], [st2$66[0], 0, st1$65[0], 0, 55])
               return (st1$65[1] = st2$66[1])
            })
            const pad$67 = _f(function (k$68, s$69) {
               const n$70 = s$69.length
               if (n$70 <= k$68) {
                  return __(oc$Pervasives$[15], [
                     s$69,
                     _(oc$String$[0], [k$68 - n$70, 97]),
                  ])
               }
               return __(oc$String$[2], [s$69, n$70 - k$68, k$68])
            })
            const full_init$71 = _f(function (s$72, seed$73) {
               const combine$74 = _f(function (accu$75, x$76) {
                  return __(pad$67, [
                     16,
                     _(oc$Pervasives$[15], [
                        accu$75,
                        _(oc$Pervasives$[19], [x$76]),
                     ]),
                  ])
               })
               const extract$77 = _f(function (d$78) {
                  return (
                     (oc$$srefs(d$78, 0) +
                        (oc$$srefs(d$78, 1) << 8) +
                        (oc$$srefs(d$78, 2) << 16)) ^
               ...
               for (
                  let i$82 = 0;
                  i$82 <= 54 + _(oc$Pervasives$[4], [55, l$79]);
                  i$82++
               ) {
                  ;(function (i$82) {
                     const j$83 = i$82 % 55
                     const k$84 = i$82 % l$79
                     accu$81 = _(combine$74, [
                        accu$81,
                        oc$$arefs(seed$73, k$84),
                     ])
                     oc$$asets(
                        s$72[0],
                        j$83,
                        oc$$arefs(s$72[0], j$83) ^ _(extract$77, [accu$81]),
                     )
                  })(i$82)
               }
               return (s$72[1] = 0)
            })
            const make$85 = _f(function (seed$86) {
               const result$87 = _(new_state$63, [0])
               _(full_init$71, [result$87, seed$86])
               return result$87
            })
            const copy$88 = _f(function (s$89) {
               const result$90 = _(new_state$63, [0])
               _(assign$64, [result$90, s$89])
               return result$90
            })
            const bits$91 = _f(function (s$92) {
               s$92[1] = (s$92[1] + 1) % 55
               const newval$93 =
                  (oc$$arefs(s$92[0], (s$92[1] + 24) % 55) +
                     oc$$arefs(s$92[0], s$92[1])) &
                  1073741823
               oc$$asets(s$92[0], s$92[1], newval$93)
               return newval$93
            })
            const intaux$94 = _f(function (s$95, n$96) {
            ...
            const int$99 = _f(function (s$100, bound$101) {
               if (bound$101 > 1073741823 || bound$101 <= 0) {
                  return __(oc$Pervasives$[0], ["Myrandom.int"])
               }
               return __(intaux$94, [s$100, bound$101])
            })
            const int32aux$102 = _f(function (s$103, n$104) {
               const b1$105 = _(bits$91, [s$103])
               const b2$106 = (_(bits$91, [s$103]) & 1) << 30
            ...
            const int32$109 = _f(function (s$110, bound$111) {
               if (bound$111 <= 0) {
                  return __(oc$Pervasives$[0], ["Random.int32"])
               }
               return __(int32aux$102, [s$110, bound$111])
            })
            const int64aux$112 = _f(function (s$113, n$114) {
               const b1$115 = _(bits$91, [s$113])
               const b2$116 = _(bits$91, [s$113]) << 30
               const b3$117 = (_(bits$91, [s$113]) & 7) << 60
               const r$118 = b1$115 | (b2$116 | b3$117)
            ...
            const int64$120 = _f(function (s$121, bound$122) {
               if (bound$122 <= "0") {
      ...
      const oc$Util$ = (function () {
         const pi$74 = Math.atan2(0.0, -1.0)
         const mod_float$27$75 = _f(function (a$76, b$77) {
         ...
         const rgb_range$94 = _f(function ($2Aopt$2A$95, $2Aopt$2A$98, x$101) {
            const min$96 = $2Aopt$2A$95 ? $2Aopt$2A$95[0] : -1.0
            const max$99 = $2Aopt$2A$98 ? $2Aopt$2A$98[0] : 1.0
            return (
               min$96 +
               (max$99 - min$96) * (0.5 + Math.atan(2.0 * x$101) / pi$74)
            )
         })
         ...
         const rnd_name$109 = _f(function (n1$110, n2$111) {
            ...
            const syllable$115 = _f(function (param$417) {
               ...
               const consonants$117 = caml_obj_dup(
                  $(
                     "b",
                     "bl",
                     "bv",
            ...
            const ending$120 = _f(function (param$416) {
               const noun$121 = caml_obj_dup(
                  $(
                     "",
                     "",
                     "",
            ...
            const make$125 = _f(function (k$126) {
               if (k$126 <= 0) {
                  return ""
               }
            ...
            const noun$131 = _(oc$Pervasives$[15], [
               _(prob$102, [0]) < 0.5 ? "" : _(pick$112, [prefix$114]),
               _(make$125, [n1$110]),
            ])
            const adj$132 = _(oc$Pervasives$[15], [
               _(prob$102, [0]) < 0.5 ? "" : _(pick$112, [prefix$114]),
               _(make$125, [n2$111]),
            ])
            return __(oc$Pervasives$[15], [
               ...
               _(oc$Pervasives$[15], [
                  ...
                  _(oc$Pervasives$[15], [
                     " ",
                     _(oc$Pervasives$[15], [noun$131, match$415[0]]),
                  ]),
               ]),
            ])
         })
         const split_name$133 = _f(function (str$134) {
            try {
               ...
               return $(
                  ...
                  _(oc$String$[2], [
                     str$134,
                     k$135 + 1,
                     str$134.length - k$135 - 1,
                  ]),
               )
            } catch (exn$414) {
               if (exn$414[0] === Not_found$20g) {
                  return $(_(oc$Pervasives$[15], [str$134, " "]), str$134)
               }
               throw exn$414
            }
         })
         const nest$136 = _f(function (f$137, x$138, n$139) {
            if (n$139 <= 0) {
               return x$138
            }
            return __(f$137, [_(nest$136, [f$137, x$138, n$139 - 1])])
         })
         const rnd_partition$140 = _f(function (q$141, k$142) {
            const inc$143 = _f(function (param$411) {
               ...
               if ($r140) {
                  {
                     ...
                     if (match$413) {
                        return $(
                           match$413[0],
                           _(inc$143, [$(n$146 - 1, match$413[1])]),
                        )
                     }
                     return __(oc$Pervasives$[1], [
                        "rnd_partition: an impossible thing happened",
                     ])
                  }
               }
            })
         ...
         const map_range$152 = _f(function (f$153, a$154, b$155) {
            if (a$154 > b$155) {
               return 0
            }
         ...
         const pick_exp$158 = _f(function (p$159, lst$160) {
            const pck$161 = _f(function (u$162, v$163, param$410) {
               if (param$410) {
                  {
            ...
            const q$168 = _(rnd_float$106, [
               0.0,
               1.0 - Math.pow(1.0 - p$159, n$167),
            ])
            return __(pck$161, [p$159, q$168, lst$160])
         })
         const pick_exp_maybe$169 = _f(function (p$170, lst$171) {
            const pck$172 = _f(function (u$173, v$174, param$409) {
               if (!param$409) {
                  return 0
               }
               if (v$174 <= u$173) {
         ...
         const pick$178 = _f(function (lst$179) {
            return __(oc$List$[3], [
               lst$179,
               _(rnd_int$103, [0, _(oc$List$[0], [lst$179]) - 1]),
            ])
         })
         const pick_many$180 = _f(function (n$181, lst$182) {
            const split$183 = _f(function (n$184, param$407) {
               if (param$407) {
                  {
            ...
            const pck$189 = _f(function (n$190, lst$191, xs$192) {
               if (n$190 === 0) {
                  return xs$192
               }
         ...
         const index_of$196 = _f(function (x$197, param$405) {
            if (!param$405) {
         ...
         const enumerate$200 = _f(function (lst$201) {
            const enum$202 = _f(function (k$203, param$404) {
               if (param$404) {
                  return $(
                     $(param$404[0], k$203),
                     _(enum$202, [k$203 + 1, param$404[1]]),
                  )
               }
               return 0
            })
         ...
         const unionq$206 = _f(function (x$207, lst$210) {
            if (lst$210) {
               {
         ...
         const count$211 = _f(function (lst$212, tok$213) {
         ...
         const rgb_of_color$223 = _f(function (param$401) {
            return $(
         ...
         const rgb_of_hsl$227 = _f(function (h$228, sl$229, l$230) {
            const v$231 =
               l$230 <= 0.5
                  ? l$230 * (1.0 + sl$229)
            ...
            const sv$233 = (v$231 - m$232) / v$231
            const h6$234 = Math.abs(h$228 * 6.0)
            const sextant$235 = (h6$234 >> 0) % 6
         ...
         const rnd_color$240 = _f(function (param$400) {
         ...
         const string_of_color$265 = _f(function (param$395) {
            return __(oc$Pervasives$[15], [
               ...
               _(oc$Pervasives$[15], [
                  ...
                  _(oc$Pervasives$[15], [
                     ...
                     _(oc$Pervasives$[15], [
                        ", ",
                        _(oc$Pervasives$[20], [param$395[2]]),
                     ]),
                  ]),
               ]),
            ])
         })
         const string_of_palette$269 = _f(function (p$270) {
            return __(oc$String$[5], [
               "\n",
               _(oc$List$[10], [string_of_color$265, p$270]),
            ])
         })
         const mix$271 = _f(function (t$272, param$392, param$393) {
            const u$279 = 1.0 - t$272
            return $(
               t$272 * param$392[0] + u$279 * param$393[0],
               t$272 * param$392[1] + u$279 * param$393[1],
               t$272 * param$392[2] + u$279 * param$393[2],
            )
         })
         const mix3$280 = _f(
            function (u$281, v$282, param$388, param$389, param$390) {
         ...
         const minimize$310 = _f(function (f$311, lst$312) {
            const m$313 = _f(function (y$314, v$315, param$382) {
               if (param$382) {
                  {
         ...
         const put$324 = _f(function (x$325, v$326, param$381) {
            if (param$381) {
               {
         ...
         const uniq$331 = _f(function (param$380) {
            if (param$380) {
               {
         ...
         const union$334 = _f(function (lst$335) {
         ...
         const prng_init$336 = _f(function (str$337) {
            if (oc$$sneq(str$337, "")) {
               {
                  ...
                  for (let i$340 = 0; i$340 <= n$338 - 1; i$340++) {
                     ;(function (i$340) {
                        oc$$asets(
                           a$339,
                           i$340,
                           i$340 * i$340 + oc$$srefs(str$337, i$340),
                        )
                     })(i$340)
                  }
      ...
      const oc$Op$ = (function () {
         const op_scalar$83 = _f(function (name$84, r$85) {
            return $(
               name$84,
               0,
               1,
               _f(function (param$968, param$969, param$970) {
                  return $1(r$85[0])
               }),
            )
         })
         const op_pt$86 = _f(function (x$87, y$88) {
            return $(
               "pt",
               0,
               2,
               _f(function (param$964, param$965, param$966) {
                  return $2(x$87[0], y$88[0])
               }),
            )
         })
         const O$491 = (function () {
            const palette_f$89 = $(
               "palette_f",
               $(1, 0),
               3,
                           ...
                           r$362: {
                              {
                                 ...
                                 return _f(function (param$930) {
                                    const match$932 = _(oc$Types$[0], [
                                       param$929[0],
                                    ])
                                    switch ($t(match$932)) {
                                       case 2:
                                          const match$931 = _(oc$Types$[0], [
                                             match$933[0],
                                          ])
                                          switch ($t(match$931)) {
                                             case 1:
                                                const x$115 = Math.abs(
                                                   match$932[0],
                                                )
                                                const y$116 = Math.abs(
                                                   match$932[1],
                                                )
                                                const z$117 = Math.abs(
                                                   match$931[0],
                                                )
                                                const t$118 =
                                                   1.0 / (x$115 + y$116 + z$117)
                                                const c$119 = _(oc$Util$[29], [
                                                   x$115 * t$118,
                                                   y$116 * t$118,
                                                   match$935[0],
                                                   match$936[0],
                           ...
                           r$350: {
                              {
                                 ...
                                 return _f(function (param$915) {
                                    const match$917 = _(oc$Types$[0], [
                                       param$914[0],
                                    ])
                                    switch ($t(match$917)) {
                                       case 2:
                                          const match$916 = _(oc$Types$[0], [
                                             match$918[0],
                                          ])
                                          switch ($t(match$916)) {
                                             case 2:
                                                const x$132 = Math.abs(
                                                   match$917[0],
                                                )
                                                const y$133 = Math.abs(
                                                   match$917[1],
                                                )
                                                const z$134 = Math.abs(
                                                   match$916[0],
                                                )
                                                const w$135 = Math.abs(
                                                   match$916[1],
                                                )
                                                const t$136 =
                                                   1.0 /
                        ...
                        return _f(function (param$907) {
                           ...
                           switch ($t(match$909)) {
                              case 3:
                                 ...
                                 const g$141 = c$143[1]
                                 const r$140 = c$143[0]
                                 const match$908 = _(oc$Types$[0], [
                                    match$910[0],
                                 ])
                                 switch ($t(match$908)) {
                                    case 1:
                                       const t$145 = _(oc$Pervasives$[4], [
                                          1.0,
                                          _(oc$Util$[2], [
                                             0,
                                             0,
                                       ...
                                       const d$148 = 1.0 / (mx$146 - mn$147)
                                       return $3(
                                          _(oc$Util$[28], [
                                             t$145,
                                             c$143,
                                             _(oc$Util$[20], [
                                                2.0 * (r$140 - mn$147) * d$148 -
                                                   1.0,
                                                2.0 * (g$141 - mn$147) * d$148 -
                                                   1.0,
                                                2.0 * (b$142 - mn$147) * d$148 -
                                                   1.0,
                                             ]),
                                          ]),
                                       )
                                 ...
                                 case 2:
                                    ...
                                    switch ($t(match$879)) {
                                       case 2:
                                          ...
                                          const r$186 = Math.sqrt(
                                             u$27$183 * u$27$183 +
                                                v$27$184 * v$27$184,
                                          )
                                          return $2(
                                             x$181 + r$186 * Math.cos(phi$185),
                                             y$182 + r$186 * Math.sin(phi$185),
                                          )
                                       default:
                                          throw $(
                                             Match_failure$16g,
            ...
            const fold$187 = $(
               ...
               _f(function (param$864) {
                  ...
                  const wgh1$190 = _(oc$Pervasives$[4], [
                     0.0,
                     _(oc$Util$[2], [
                        0,
                        0,
                  ...
                  const wgh2$191 = _(oc$Pervasives$[4], [
                     0.0,
                     _(oc$Util$[2], [
                        0,
                        0,
                  ...
                  const x1$194 = (1.0 - wgh1$190) * match$873[0]
                  const y1$195 = (1.0 - wgh1$190) * match$873[1]
                  const phi$196 =
                     (1.0 - wgh2$191) *
                     2.0 *
                     oc$Util$[0] *
                                       ...
                                       case 2:
                                          ...
                                          switch ($t(match$867)) {
                                             case 1:
                                                const x$27$205 =
                                                   x1$194 +
                                                   wgh1$190 * match$869[0]
                                                const y$27$206 =
                                                   y1$195 +
                                                   wgh1$190 * match$869[1]
            ...
            const dist$213 = $(
               ...
               _f(function (param$854) {
                  const wgh$216 = _(oc$Pervasives$[4], [
                     0.0,
                     _(oc$Util$[2], [
                        0,
                        0,
                        $(-0.2),
                        $(0.5),
                        _(oc$Util$[14], [param$854[1]]),
                     ]),
                  ])
                  const match$861 = _(oc$Util$[14], [param$854[0]])
                  const x1$219 = (1.0 - wgh$216) * match$861[0]
                  const y1$220 = (1.0 - wgh$216) * match$861[1]
            ...
            const rotate$229 = $(
               ...
               _f(function (param$842) {
                  ...
                  const wgh1$232 = _(oc$Pervasives$[4], [
                     0.0,
                     _(oc$Util$[2], [
                        0,
                        0,
                  ...
                  const wgh2$233 = _(oc$Pervasives$[4], [
                     0.0,
                     _(oc$Util$[2], [
                        0,
                        0,
                  ...
                  const x1$236 = (1.0 - wgh1$232) * match$851[0]
                  const y1$237 = (1.0 - wgh1$232) * match$851[1]
                  const phi$238 =
                     (1.0 - wgh2$233) *
                     2.0 *
                     oc$Util$[0] *
                     ...
                     r$259: {
                        {
                           ...
                           return _f(function (param$844) {
                              ...
                              switch ($t(match$847)) {
                                 case 2:
                                    const match$846 = _(oc$Types$[0], [
                                       match$848[0],
                                    ])
                                    switch ($t(match$846)) {
                                       case 2:
                                          const match$845 = _(oc$Types$[0], [
                                             match$849[0],
                                          ])
                                          switch ($t(match$845)) {
                                             case 1:
                                                const x$27$247 =
                                                   x1$236 +
                                                   wgh1$232 * match$847[0]
                                                const y$27$248 =
                                                   y1$237 +
                                                   wgh1$232 * match$847[1]
                                                const a$249 =
                                                   match$846[0] - x$27$247
                                                const b$250 =
                                                   match$846[1] - y$27$248
                                                const t$27$251 =
                                                   phi$238 +
                                                   wgh2$233 *
                                                      2.0 *
               ...
               _f(function (param$832) {
                  ...
                  const t$259 = _(oc$Pervasives$[4], [
                     ...
                     _(oc$Util$[2], [
                        ...
                        $(-0.1),
                        $(0.8),
                        _(oc$Util$[14], [param$832[1]]),
                     ]),
                  ])
                  const a$260 = 0.1 * (1.0 - t$259) * match$839[0]
                  const b$261 = 0.1 * (1.0 - t$259) * match$839[1]
                     ...
                     r$241: {
                        {
                           ...
                           return _f(function (param$834) {
                              ...
                              switch ($t(match$836)) {
                                 case 2:
                                    const match$835 = _(oc$Types$[0], [
                                       match$837[0],
                                    ])
                                    switch ($t(match$835)) {
                                       case 2:
                                          const a$27$268 =
                                             match$835[0] * t$259 + a$260
                                          const b$27$269 =
                                             match$835[1] * t$259 + b$261
                                          return $2(
                                             a$27$268 *
                                                Math.floor(
                                                   match$836[0] / a$27$268,
                                                ),
                                             b$27$269 *
                                                Math.floor(
                                                   match$836[1] / b$27$269,
                                                ),
                                          )
                                       default:
                                          throw $(
                  ...
                  r$233: {
                     {
                        ...
                        return _f(function (param$826) {
                           ...
                           switch ($t(match$828)) {
                              case 2:
                                 const match$827 = _(oc$Types$[0], [
                                    match$829[0],
                                 ])
                                 switch ($t(match$827)) {
                                    case 2:
                                       return $2(
                                          0.5 * (match$828[0] + match$827[0]),
                                          0.5 * (match$828[1] + match$827[1]),
                                       )
                                    default:
                                       throw $(
                                          Match_failure$16g,
                  ...
                  r$227: {
                     {
                        ...
                        return _f(function (param$818) {
                           ...
                           switch ($t(match$820)) {
                              case 1:
                                 const match$819 = _(oc$Types$[0], [
                                    match$821[0],
                                 ])
                                 switch ($t(match$819)) {
                                    case 1:
                                       return $1(
                                          0.5 * (match$820[0] + match$819[0]),
                                       )
                                    default:
                                       throw $(
                                          Match_failure$16g,
                  ...
                  r$214: {
                     {
                        ...
                        return _f(function (param$797) {
                           ...
                           switch ($t(match$800)) {
                              case 1:
                                 const match$799 = _(oc$Types$[0], [
                                    match$801[0],
                                 ])
                                 switch ($t(match$799)) {
                                    case 1:
                                       const match$798 = _(oc$Types$[0], [
                                          match$802[0],
                                       ])
                                       switch ($t(match$798)) {
                                          case 1:
                  ...
                  r$206: {
                     {
                        ...
                        return _f(function (param$787) {
                           ...
                           switch ($t(match$790)) {
                              case 2:
                                 const match$789 = _(oc$Types$[0], [
                                    match$791[0],
                                 ])
                                 switch ($t(match$789)) {
                                    case 2:
                                       const match$788 = _(oc$Types$[0], [
                                          match$792[0],
                                       ])
                                       switch ($t(match$788)) {
                                          case 1:
                                             const t$307 = Math.abs(
                                                _(oc$Util$[2], [
                                                   0,
                                                   0,
                                                   0,
                                             ...
                                             return $2(
                                                t$307 * match$790[0] +
                                                   (1.0 - t$307) * match$789[0],
                                                t$307 * match$790[1] +
                                                   (1.0 - t$307) * match$789[1],
                                             )
                                          default:
                                             throw $(
                                                Match_failure$16g,
            ...
            const fsin$315 = $(
               ...
               _f(function (param$766) {
                  const f$317 =
                     10.0 * oc$Util$[0] * _(oc$Util$[14], [param$766[1]])
                  ...
                  r$185: {
                     {
                        ...
                        return _f(function (param$762) {
                           ...
                           switch ($t(match$763)) {
                              case 1:
                                 return $1(
                                    2.0 * Math.sqrt(Math.abs(match$763[0])) -
                                       1.0,
                                 )
                              default:
                  ...
                  r$169: {
                     {
                        ...
                        return _f(function (param$738) {
                           ...
                           switch ($t(match$741)) {
                              case 1:
                                 const match$740 = _(oc$Types$[0], [
                                    match$742[0],
                                 ])
                                 switch ($t(match$740)) {
                                    case 3:
                                       const match$739 = _(oc$Types$[0], [
                                          match$743[0],
                                       ])
                                       switch ($t(match$739)) {
                                          case 3:
                     ...
                     r$133: {
                        {
                           ...
                           return _f(function (param$693) {
                              ...
                              switch ($t(match$695)) {
                                 case 2:
                                    const match$694 = _(oc$Types$[0], [
                                       match$696[0],
                                    ])
                                    switch ($t(match$694)) {
                                       case 2:
                                          const a$372 =
                                             match$695[0] - match$694[0]
                                          const b$373 =
                                             match$695[1] - match$694[1]
                                          return $(
                                             a$372 * a$372 + b$373 * b$373 <
                                                r2$365,
                                          )
                                       default:
                                          throw $(
            ...
            const pfoci$374 = $(
               ...
               _f(function (param$675) {
                  ...
                  const n$377 = _(oc$Pervasives$[3], [
                     _(oc$List$[0], [f$375]),
                     _(oc$List$[0], [s$376]),
                  ])
                  const k$378 = _(oc$Util$[5], [2, n$377])
                  const p$379 = _(oc$Pervasives$[4], [
                     0.0,
                     _(oc$Util$[2], [
                        0,
                        0,
                           ...
                           return _f(function (param$677) {
                              ...
                              switch ($t(match$685)) {
                                 case 2:
                                    ...
                                    const t$389 = _(oc$Types$[0], [
                                       match$686[0],
                                    ])
                                    const match$684 = _(oc$Types$[0], [
                                       match$687[0],
                                    ])
                                    switch ($t(match$684)) {
                                       case 2:
                                          try {
                                             const match$681 = _(oc$List$[25], [
                                                _f(function (param$679) {
                                                   const match$680 =
                                                      param$679[0]
                                                   const a$397 =
                                                      x$387 -
            ...
            const pclosestmax$399 = $(
               ...
               _f(function (param$663) {
                  ...
                  const ps$402 = _(oc$Util$[15], [
                     _(oc$Util$[5], [(n$401 / 2) >> 0, n$401]),
                     f$400,
                  ])
                     ...
                     r$104: {
                        {
                           ...
                           return _f(function (param$665) {
                              ...
                              switch ($t(match$669)) {
                                 case 2:
                                    const match$668 = _(oc$Types$[0], [
                                       match$670[0],
                                    ])
                                    switch ($t(match$668)) {
                                       case 1:
                                          const t$407 = match$668[0]
                                          const match$667 = _(oc$Util$[31], [
                                             _f(function (param$666) {
                                                return __(oc$Pervasives$[4], [
                                                   t$407 * param$666[0] -
                                                      match$669[0],
                                                   t$407 * param$666[1] -
                                                      match$669[1],
            ...
            const fclosest$412 = $(
               ...
               _f(function (param$653) {
                  ...
                  const ss$415 = _(oc$Util$[15], [
                     _(oc$Util$[5], [(n$414 / 2) >> 0, n$414]),
                     s$413,
                  ])
                  ...
                  r$87: {
                     {
                        ...
                        return _f(function (param$645) {
                           ...
                           switch ($t(match$648)) {
                              case 2:
                                 const match$647 = _(oc$Types$[0], [
                                    match$649[0],
                                 ])
                                 switch ($t(match$647)) {
                                    case 1:
                                       const a$427 = match$647[0]
                                       const match$646 = _(oc$Types$[0], [
                                          match$650[0],
                                       ])
                                       switch ($t(match$646)) {
                                          case 1:
                  ...
                  r$45: {
                     {
                        ...
                        return _f(function (param$596) {
                           ...
                           switch ($t(match$599)) {
                              case 2:
                                 const match$598 = _(oc$Types$[0], [
                                    match$600[0],
                                 ])
                                 switch ($t(match$598)) {
                                    case 1:
                                       const h$468 = _(oc$Util$[2], [
                                          0,
                                          0,
                                          $(0.0),
                                          $(1.0),
                        ...
                        return _f(function (param$590) {
                           ...
                           switch ($t(match$591)) {
                              case 1:
                                 ...
                                 return $3(
                                    _(oc$Util$[20], [x$476, x$476, x$476]),
                                 )
                              default:
                  ...
                  r$30: {
                     {
                        ...
                        return _f(function (param$580) {
                           ...
                           switch ($t(match$583)) {
                              case 1:
                                 const match$582 = _(oc$Types$[0], [
                                    match$584[0],
                                 ])
                                 switch ($t(match$582)) {
                                    case 1:
                                       const match$581 = _(oc$Types$[0], [
                                          match$585[0],
                                       ])
                                       switch ($t(match$581)) {
                                          case 1:
         ...
         const ops_sort$493 = _f(function (s$494) {
         ...
         const reduce$508 = _f(function (fs$509) {
            const n$510 = _(oc$List$[0], [fs$509])
            return __(oc$Util$[15], [
               _(oc$Util$[5], [1 + ((n$510 / 5) >> 0), n$510]),
               fs$509,
            ])
         })
         return $(
      ...
      const oc$Gene$ = (function () {
         ...
         const get_sort$95 = _f(function (s$96, lst$97) {
            return __(oc$List$[26], [
               _f(function (l$98) {
         ...
         const connectible$99 = _f(function (f$100, gene$101) {
         ...
         const random_foci$104 = _f(function (n$105) {
         ...
         const random_scalars$108 = _f(function (n$109) {
            return __(oc$Util$[11], [
         ...
         const random_palette$110 = _f(function (n$111) {
         ...
         const connect$123 = _f(function (f$124, lst$125) {
            return $(
               f$124,
               _(oc$List$[10], [
                  _f(function (s$126) {
                     return __(oc$Util$[12], [
                        0.2,
                        _(get_sort$95, [s$126, lst$125]),
                     ])
                  }),
                  _(oc$Op$[7], [f$124]),
               ]),
         ...
         const random_gene$127 = _f(
            function (ops$128, seed$129, res$130, k$131) {
               const make$132 = _f(function (j$133, lst$134, lst1$135) {
                  if (j$133 <= 1) {
                     {
                        const ops1$136 = _(oc$List$[26], [
                           _f(function (f$137) {
                              return __(connectible$99, [f$137, lst1$135])
                           }),
                           ops$128,
                        ])
                        const fs$139 = _(oc$List$[26], [
                           _f(function (f$138) {
                              return __(oc$List$[23], [
                                 _(oc$Op$[8], [f$138]),
                                 res$130,
                              ])
                           }),
                        ...
                        const lnk$140 = _(connect$123, [
                           _(oc$Util$[14], [ops1$136]),
                           lst1$135,
                        ])
                        return __(make$132, [
                           j$133 - 1,
                  ...
                  const match$220 = _(oc$List$[13], [
                     _f(function (param$217, param$218) {
                        const g$154 = _(random_gene$127, [
                           ops$128,
                           lst1$135,
                           $(param$217[0], 0),
                           param$217[1],
                        ...
                        if (g$154) {
                           return $(
                              param$218[0] - _(oc$List$[0], [g$154]),
                              $(g$154[0], param$218[1]),
                              _(oc$Pervasives$[21], [g$154, param$218[2]]),
                     ...
                     _(oc$List$[36], [
                        _(oc$Op$[7], [f$141]),
                        _(oc$Util$[10], [
                           _(oc$Util$[5], [1, j$133 - 1]),
                           _(oc$List$[0], [_(oc$Op$[7], [f$141])]),
                        ]),
                     ]),
         ...
         const random_dna$156 = _f(
            function (ops$157, seed$158, res$159, k$160, n$161) {
               const reduce$162 = _f(function (ts$163, param$215) {
                  if (param$215) {
                     {
                        ...
                        return $(
                           l$164,
                           _(reduce$162, [$(t$166, ts$163), ls$165]),
                        )
                     }
                  }
                  return 0
               ...
               const g1$168 = _(random_gene$127, [
                  ops$157,
                  seed$158,
                  $(0, $(1, $(2, $(3, 0)))),
                  k$160,
               ...
               if (g1$168) {
                  {
                     ...
                     const g2$170 = _(random_gene$127, [
                        ops$157,
                        seed$158,
                        $(0, $(1, $(2, $(3, 0)))),
                        k$160,
         ...
         const optimize$172 = _f(function (g$173) {
            const coll$174 = _f(function (acc$176, param$212) {
               if (param$212) {
                  {
            ...
            const collect$175 = _f(function (acc$179, lnk$180) {
               return __(coll$174, [
                  _(oc$Util$[18], [lnk$180, acc$179]),
                  _(connectors$84, [lnk$180]),
               ])
            })
         ...
         const string_of_gene$183 = _f(function (g$184) {
      ...
      const oc$Compute$ = (function () {
         const default_color$74 = _(oc$Util$[20], [0.0, 0.0, 0.0])
         const default$75 = _f(function (param$145) {
            switch (param$145) {
               case 0:
                  return $(false)
               case 1:
         ...
         const make_cell$76 = _f(function (cells$77, f$78, env$79) {
            return $(
               $(_(default$75, [_(oc$Op$[8], [f$78])])),
               _(oc$Op$[10], [f$78, env$79, cells$77]),
            )
         })
         const compile$80 = _f(function (rna$81, env$82) {
            const cmpl$83 = _f(function (param$142) {
               if (param$142) {
                  {
                     const l$84 = param$142[0]
                     const match$143 = _(cmpl$83, [param$142[1]])
                     const asc$87 = match$143[1]
                     const c$88 = _(make_cell$76, [
                        _(oc$List$[10], [
                           _f(function (r$89) {
         ...
         const random_picture$90 = _f(function (str$91) {
            ...
            const palette$99 = $(
               _(oc$Util$[20], [-1.0, -1.0, -1.0]),
               $(
                  _(oc$Util$[20], [1.0, 0.0, 1.0]),
                  _(oc$Gene$[10], [_(oc$Util$[5], [2, 10])]),
               ),
            )
          ...
          */
            ...
            const seed$103 = $(
               _(oc$Gene$[5], [x$94, y$95]),
               $(_(oc$Gene$[4], [t$96]), 0),
            )
            const g$104 = _(oc$Gene$[14], [
               _(oc$Pervasives$[21], [
                  _(oc$Gene$[12], [ops$102, seed$103, $(3, 0), n$101]),
                  seed$103,
               ]),
            ])
         ...
         const random_picture$2 = _f(function (na$91, na$92) {
            const r$122 = new oc$$ms(na$92)
            const r$132 = new oc$$ms(na$91)
            const match$141 = [r$122, r$132]
            // const match$141 = _(oc$Util$[8], [str$91]);
            console.log("Orig Given Prefix:", na$91, match$141[0])
            console.log("Orig Family Suffix:", na$92, match$141[1])
            const x$94 = $(0.0)
            const y$95 = $(0.0)
            const t$96 = $(-1.0)
            _(oc$Util$[36], [match$141[0]])
          ...
          console.log('Orig Palette (-1,-1,-1; 1,0,1; 2-10):', util.inspect(palette$99, 10, 10, 10));
          */
            _(oc$Util$[36], [match$141[1]])
            const n$101 = _(oc$Util$[5], [120, 200])
            const ops$102 = _(oc$Op$[11], [oc$Op$[3]])
            ...
            const dna$105 = _(compile$80, [g$104, env$100])
            /*
          console.log('Orig N (120-200):', n$101);
         ...
         const random_picture$3 = _f(function (na$91, na$92) {
            const r$122 = new oc$$ms(na$92)
            const r$132 = new oc$$ms(na$91)
            const match$141 = [r$122, r$132]
            // const match$141 = _(oc$Util$[8], [str$91]);
            console.log("Novel Given Prefix:", na$92, match$141[0])
            console.log("Novel Family Suffix:", na$91, match$141[1])
            const x$94 = $(0.0)
            const y$95 = $(0.0)
            const t$96 = $(-1.0)
            _(oc$Util$[36], [match$141[0]])
            const scalars$97 = _(oc$Gene$[9], [12])
            const foci$98 = _(oc$Gene$[8], [_(oc$Util$[5], [4, 25])])
            const palette$99 = $(
               _(oc$Util$[20], [-1.0, 0, -1.0]),
               $(
                  _(oc$Util$[20], [1.0, 1.0, 1.0]),
                  _(oc$Gene$[10], [_(oc$Util$[5], [3, 12])]),
               ),
            )
            const env$100 = $(foci$98, scalars$97, palette$99)
            /*
          console.log('Novel Foci (4-25):', util.inspect(foci$98, 25, 25, 25));
          console.log('Novel Scalars (12):', util.inspect(scalars$97, 12, 12, 12));
          console.log('Novel Palette (-1,0,-1; 1,1,1; 3-12):', util.inspect(palette$99, 10, 10, 10));
          */
            _(oc$Util$[36], [match$141[1]])
            const n$101 = _(oc$Util$[5], [110, 185])
            const ops$102 = _(oc$Op$[11], [oc$Op$[3]])
            const seed$103 = $(
               _(oc$Gene$[5], [x$94, y$95]),
               $(_(oc$Gene$[4], [t$96]), 0),
            ...
            const dna$105 = _(compile$80, [g$104, env$100])
            /*
          console.log('Novel N (110-185):', n$101);
         ...
         const run$109 = _f(function (param$139) {
            if (param$139) {
               {
         ...
         const eval$112 = _f(function (rna$113, t$114, x$115, y$116) {
            const prog$117 = _(rna$113, [t$114, x$115, y$116])
            const match$138 =
               (_(run$109, [prog$117]),
               _(oc$Types$[0], [_(oc$List$[1], [prog$117])]))
            switch ($t(match$138)) {
               case 3:
         ...
         const compute_line$119 = _f(
            function (rna$120, res$121, t$122, j$123, line$124) {
               const d$125 = 2.0 / res$121
               for (let i$126 = 0; i$126 <= res$121 - 1; i$126++) {
                  ;(function (i$126) {
                     const prog$127 = _(rna$120, [
                        t$122,
                        d$125 * (0.5 + i$126) - 1.0,
                        d$125 * (0.5 + j$123) - 1.0,
                     ])
                     const match$137 =
                        (_(run$109, [prog$127]),
                        _(oc$Types$[0], [_(oc$List$[1], [prog$127])]))
                     switch ($t(match$137)) {
                        case 3:
      ...
      const oc$Genjs$ =
         ...
         (ocamlRegister(
            "newPicture",
            _(
               _f(function (callable, array$1, array$2) {
                  return caml_callback2(callable, array$2, array$1)
               }),
               [oc$Compute$[8]],
            ),
         ),
         (ocamlRegister(
            "newNewPicture",
            _(
               _f(function (prim$72, array$71, array$70) {
                  return caml_callback2(prim$72, array$70, array$71)
               }),
               [oc$Compute$[9]],
            ),
         ),
         (ocamlRegister(
            "oldPicture",
            _(
               _f(function (prim$72, param) {
                  return caml_callback(prim$72, param)
               }),
               [oc$Compute$[4]],
            ),
         ),
         (ocamlRegister(
            "fullEval",
            _(
               _f(function (prim$0, model$1, zero$2, x$3, y$4) {
         ...
         (ocamlRegister(
            "substringChars",
            _(
               _f(function (sub$74, s$1, ofs$2, len$3) {
                  return caml_callback3(sub$74, s$1, ofs$2, len$3)
               }),
               [oc$String$[2]],
            ),
         ),
         $()))))))))
      const oc$Std_exit$ = (_(oc$Pervasives$[80], [0]), $())
...
// export default methodHolder
const newNewPicture = methodHolder.newNewPicture
export { newNewPicture }

const newPicture = methodHolder.newPicture
export { newPicture }

const oldPicture = methodHolder.oldPicture
export { oldPicture }

const computePixel = methodHolder.computePixel
export { computePixel }

const phraseToSeed = methodHolder.phraseToSeed
export { phraseToSeed }

const partialEval = methodHolder.partialEval
export { partialEval }

const fullEval = methodHolder.fullEval
export { fullEval }
