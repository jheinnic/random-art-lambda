...
def create_plot_maps(_width, _height, top, left, bottom, right, f_doc="fdoc.proto", g_doc="gdoc.proto", h_doc="hdoc.proto", sample_multi=5.73, seed=1234):
    ...
    print("F ROWS Again 1-3, X")
    print(f[:, 0].reshape([width*height][0:width]))
    print("F COLS Again 1-3, Y")
    print(f[:, 1].reshape([width*height])[0:height])
    ...
    print(h[:, 0].reshape([width*height][0:width]))
    print("COLS Again 1-3, Y")
    print(h[:, 1].reshape([width*height])[0:height])
    # print(h[0:320, :])
    # print("ROW 2")
    # print(h[320:640, :])
    # ii = 320 * 237
...
create_plot_maps(width, height, ymax, xmin, ymin, xmax, f_doc="fdoc-025_075-n075_n025-512_512.proto", g_doc="gdoc-025_075-n075_n025-512_512.proto", h_doc="hdoc-025_075-n075_n025-512_512.proto", sample_multi=_sample_multi, seed=_seed)
